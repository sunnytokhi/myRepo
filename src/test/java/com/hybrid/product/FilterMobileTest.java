...
public class FilterMobileTest extends BaseTest {
	...
	@BeforeTest
	public void init() {
		xls = new Xls_Reader(Constants.PRODUCT_SUITE_XLS);
		testName = "FilterMobileTest";
	}

	@Test(dataProvider = "getData")
	public void filterMobileTest(Hashtable<String, String> data) throws InterruptedException {
		...
		System.out.println("Location : " + System.getProperty("user.dir") + "\\data\\ProductSuite.xlsx");
